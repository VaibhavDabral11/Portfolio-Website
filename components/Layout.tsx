...
const Layout: FC<Props> = ({ children }) => {
  ...
  return (
    <>
      ...
      <div
        onClick={scrollUp}
        className="fixed bg-[#0f141e4d] cursor-pointer flex justify-center transition-all duration-500 items-center hover:bg-[#0f141e] z-50 bottom-8 right-10 rounded-full w-10 h-10"
      >
